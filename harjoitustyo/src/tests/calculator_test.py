...
class TestCalculator(unittest.TestCase):
    ...
    def test_calculator_works_when_last_equals_zero(self):
        self.assertEqual(str(Calculator.calculate(1, 1, 0)), "Aikuistuminen tapahtuu arviolta 1 päivän kuluttua")

    def test_calculator_works(self):
        self.assertEqual(Calculator.calculate(1, 1, 1), "Aikuistuminen tapahtuu arviolta 1 päivän kuluttua")
